...
# path_to_file = "Data/trun5_2/"
path_to_file = "/panasas/scratch/grp-jonghan/kunal/RS/par_set1_nsweep/trun5/"
...
parameter = {
    ...
    'nskip':1,     # Measurement steps (multiplied later by mx*my)
    ...
    'tloop': True  # True --> E : constant, Temperature sweep , False --> T_bath and Applied Voltage upsweep
}
...
run_par = {
    ...
    'dTb' : 0.04,    # Increment for the tempoerature
    'minT' : 0.04,   # Min temperature 
    'maxT' : 1.64,   # Max temperature
    'nmeas' : 16384,   # Number of measurements
    'Tbath' : 0.40,   # Bath temperature
    'seed' : 3941243,  # Random number generator seed
}
