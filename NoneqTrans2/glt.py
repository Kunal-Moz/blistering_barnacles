...
path_to_file = "Data_test/vrun0_d2_40/"
...
run_par = {
    ...
    'iphi' : True   # If True --> then initial Phi = 1 , False --> given distribution of phi
}
...
def run_mcloop():
    ...
    if iphi:
        ...
        phit = np.loadtxt("test_phi/phi_val_3.80.dat")
    ...
    for k in range(ndata):
        ...
        for i in range(0, nmeas):
            ...
            if i%200 == 0 :
                if tloop:
                    np.savetxt(path_to_file + "phi_val_" + format(Tbvals[k], '.2f') + "_" + str(i//200)  + "_.dat", glt.phi)
                else:
                    np.savetxt(path_to_file + "phi_val_" + format(Evals[k], '.2f') + "_" + str(i//200)  + "_.dat", glt.phi)
